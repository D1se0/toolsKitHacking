...
def main():
    print("=" * 60)
    print("        ESCÁNER DE PUERTOS COMPLETOS CON NMAP          ")
    print("=" * 60)
    print("Este script realiza un escaneo de puertos completos\n"
          "en un host específico usando escaneo SYN (-sS).\n")
    ...
    print(f"\nIniciando escaneo SYN para el host: {ip} en todos los puertos.")
    print("=" * 60)

    # Ejecuta el comando nmap
    command = ["sudo", "nmap", "-sS", ip, "-p-"]
