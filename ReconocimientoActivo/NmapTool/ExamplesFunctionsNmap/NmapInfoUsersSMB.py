...
def main():
    print("=" * 60)
    print("          ESCÁNER SMB ENUM USERS (NMAP)           ")
    print("=" * 60)
    print("Este script realiza un escaneo SMB para enumerar usuarios en un host específico usando Nmap.\n")
    ...
    command = ["sudo", "nmap", "-v", "-sS", "-p", "139,445", "--script=smb-enum-users", ip]
