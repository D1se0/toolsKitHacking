...
def main():
    print("=" * 60)
    print("    ESCÁNER DE SERVICIOS CON NMAP PARA RANGO DE IPs    ")
    print("=" * 60)
    print("Este script realiza un escaneo avanzado de servicios en un\n"
    ...
    if result.returncode == 0:
        print("✅ Escaneo completado con éxito. Los resultados se han guardado en 'servicios.xml'.\n")
        print(result.stdout)
    else:
