...
def main():
    ...
    print("Este script realiza un escaneo de vulnerabilidades en dos direcciones\n"
          ...
          "en los servicios **UDP** de ambas IPs especificadas.\n")
    ...
    print(f"\nIniciando escaneo de vulnerabilidades UDP para las IPs: {ip1} y {ip2}")
    print("=" * 60)

    # Ejecuta el comando nmap con el formato correcto para UDP
    command = [
        "sudo", "nmap", "-v", "-sU", "-oX", "vulnerabilidadesUDP.xml",
    ...
    if result.returncode == 0:
        print("✅ Escaneo completado con éxito. Resultados guardados en vulnerabilidadesUDP.xml.\n")
        print(result.stdout)
    else:
