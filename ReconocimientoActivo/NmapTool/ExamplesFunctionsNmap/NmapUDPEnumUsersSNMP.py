...
def main():
    print("=" * 60)
    print("        ESCÁNER SNMP CON NMAP Y SCRIPT snmp-win32-users          ")
    print("=" * 60)
    print("Este script realiza un escaneo de puertos UDP con SNMP\n"
          "y ejecuta el script `snmp-win32-users` en un host específico.\n")
    ...
    command = ["sudo", "nmap", "-v", "-sU", "-p161", "--script=snmp-win32-users", ip]
