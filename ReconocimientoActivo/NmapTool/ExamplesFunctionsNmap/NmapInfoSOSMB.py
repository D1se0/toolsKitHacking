...
def main():
    print("=" * 60)
    print("          ESCÁNER SMB OS DISCOVERY (NMAP)           ")
    print("=" * 60)
    print("Este script realiza un escaneo SMB OS Discovery en un host específico usando Nmap.\n")
    ...
    command = ["sudo", "nmap", "-v", "-sS", "-p", "139,445", "--script=smb-os-discovery", ip]
