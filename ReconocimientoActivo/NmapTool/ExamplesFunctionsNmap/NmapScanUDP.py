...
def main():
    print("=" * 60)
    print("        ESCÁNER DE PUERTOS UDP COMPLETOS CON NMAP          ")
    print("=" * 60)
    print("Este script realiza un escaneo de puertos UDP completos\n"
          "en un host específico usando el escaneo UDP (-sU).\n")
    ...
    print(f"\nIniciando escaneo UDP para el host: {ip} en todos los puertos.")
    print("=" * 60)

    # Ejecuta el comando nmap
    command = ["sudo", "nmap", "-sU", ip, "-p-"]
