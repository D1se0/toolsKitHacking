...
def main():
    ...
    print("=" * 60)
    print("Este script realiza un escaneo de todos los puertos en un\n"
          "host específico para identificar versiones de servicios.\n")
    ...
    print(f"\nIniciando escaneo para el host: {ip}")
    print("=" * 60)

    # Ejecuta el comando nmap
    command = ["sudo", "nmap", "-sV", ip, "-p-"]
